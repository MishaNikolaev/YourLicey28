...
@Composable
fun First_d_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_f_d)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_f_d)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_f_d)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_f_d)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_f_d)
...
val MondaylessonInfoList_f_d = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_f_d = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_f_d = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_f_d = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_f_d = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
