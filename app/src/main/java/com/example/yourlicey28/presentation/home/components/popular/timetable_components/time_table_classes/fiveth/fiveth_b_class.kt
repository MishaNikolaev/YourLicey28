...
@Composable
fun Fiveth_b_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_5_b)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_5_b)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_5_b)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_5_b)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_5_b)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_5_b)
...
val MondaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_5_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
