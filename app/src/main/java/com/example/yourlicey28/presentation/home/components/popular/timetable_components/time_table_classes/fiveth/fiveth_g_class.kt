...
@Composable
fun Fiveth_g_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_5_g)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_5_g)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_5_g)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_5_g)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_5_g)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_5_g)
...
val MondaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_5_g = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
