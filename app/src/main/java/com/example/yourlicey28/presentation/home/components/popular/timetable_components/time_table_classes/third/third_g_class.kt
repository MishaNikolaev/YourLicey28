...
@Composable
fun Third_G_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_3_g)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_3_g)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_3_g)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_3_g)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_3_g)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_3_g)
...
val MondaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_3_g = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
