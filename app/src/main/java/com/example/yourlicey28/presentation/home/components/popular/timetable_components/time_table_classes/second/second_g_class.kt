...
@Composable
fun Second_g_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_2_g)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_2_g)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_2_g)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_2_g)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_2_g)
...
val MondaylessonInfoList_2_g = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_2_g = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_2_g = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_2_g = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_2_g = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
