...
@Composable
fun Third_A_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_3_a)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_3_a)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_3_a)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_3_a)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_3_a)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_3_a)
...
val MondaylessonInfoList_3_a = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_3_a = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_3_a = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
