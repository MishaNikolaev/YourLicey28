...
@Composable
fun First_V_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_f_v)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_f_v)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_f_v)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_f_v)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_f_v)
...
val MondaylessonInfoList_f_v = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_f_v = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_f_v = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_f_v = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_f_v = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
