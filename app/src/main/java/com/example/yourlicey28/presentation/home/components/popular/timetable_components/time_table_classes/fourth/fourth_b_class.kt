...
@Composable
fun Fourth_B_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_4_b)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_4_b)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_4_b)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_4_b)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_4_b)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_4_b)
...
val MondaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_4_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
