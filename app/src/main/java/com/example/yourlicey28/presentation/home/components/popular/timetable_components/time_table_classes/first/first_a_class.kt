...
@Composable
fun First_A_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList)
...
val ThuesdaylessonInfoList = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
