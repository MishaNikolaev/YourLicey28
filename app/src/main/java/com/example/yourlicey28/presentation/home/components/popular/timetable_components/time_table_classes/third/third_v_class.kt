...
@Composable
fun Third_V_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_3_v)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_3_v)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_3_v)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_3_v)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_3_v)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_3_v)
...
val MondaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_3_v = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
