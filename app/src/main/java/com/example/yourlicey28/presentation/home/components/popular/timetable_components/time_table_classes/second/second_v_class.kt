...
@Composable
fun Second_v_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_2_v)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_2_v)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_2_v)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_2_v)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_2_v)
...
val MondaylessonInfoList_2_v = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_2_v = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_2_v = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_2_v = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_2_v = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
