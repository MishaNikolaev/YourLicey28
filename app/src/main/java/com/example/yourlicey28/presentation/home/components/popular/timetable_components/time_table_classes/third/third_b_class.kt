package com.example.yourlicey28.presentation.home.components.popular.timetable_components.time_table_classes.third
...
@Composable
fun Third_b_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_3_b)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_3_b)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_3_b)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_3_b)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_3_b)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_3_b)
...
val MondaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_3_b = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
