...
@Composable
fun Fourth_A_Class(navController: NavHostController) {
    ...
    Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
        ...
        when (currentDayOfWeek) {
            DayOfWeek.MONDAY -> LessonCardList(MondaylessonInfoList_4_a)
            DayOfWeek.TUESDAY -> LessonCardList(ThuesdaylessonInfoList_4_a)
            DayOfWeek.WEDNESDAY -> LessonCardList(WednesdaylessonInfoList_4_a)
            DayOfWeek.THURSDAY -> LessonCardList(ThursdaylessonInfoList_4_a)
            DayOfWeek.FRIDAY -> LessonCardList(FridaylessonInfoList_4_a)
            DayOfWeek.SATURDAY -> LessonCardList(SaturdaylessonInfoList_4_a)
...
val MondaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Технология",
...
val ThursdaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Математика",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val ThuesdaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Технология",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val WednesdaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Русский язык",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val FridaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
...
val SaturdaylessonInfoList_4_a = listOf(
    LessonInfo(
        name = "Литература",
        number = "1 урок            в 8:00 - 8:40",
        room = "каб. 103",
